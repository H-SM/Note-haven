...
function Login(props) {
  ...
  <span className="font-semibold text-[17px] px-8 text-secondary-white">Don't have an account? <p onClick={handleClick} className="hover:cursor-pointer text-[#f89a0fe6]/80 hover:text-[#f89a0fe6] inline-block relative hover:underline">
  create a new account
  <span className="absolute w-full h-0.5 bg-[#f89a0fe6] transform scale-x-0 bottom-0 left-0 origin-bottom-right transition-transform duration-250 ease-out group-hover:scale-x-100"></span>
  </p></span>
    <form onSubmit={handleSubmit} className="z-20 relative p-6 pt-3">
        ...
        <span className="absolute w-0 h-0 transition-all duration-500 ease-out bg-[#e49012c8] rounded-full group-hover:w-[20rem] group-hover:h-[20rem]"></span>
        <span className="absolute inset-0 w-full h-full -mt-1 rounded-lg opacity-30 bg-gradient-to-b from-transparent via-transparent to-gray-700/50"></span>
        <span className="relative text-[20px] font-semibold">
          Submit
        </span>
        </button>
        </div>
