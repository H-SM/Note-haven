...
function Notes(props) {
  ...
  return (
    <>
    <div className='flex flex-wrap gap-3 justify-center h-full max-h-[100vh] overflow-hidden no-scrollbar overflow-y-auto w-full z-10'>
    
      <AddNote showAlert={showAlert} />
      {(notes.length===0) && <p className='w-full flex justify-center items-center text-white font-Sacramento text-[50px] mt-[5vh]'>Start your awesome journey by clicking the button above.</p>}
      ...
      notes.filter((note) =>
        ...
        <p className=' text-white font-Sacramento text-[50px] mt-[5vh]'>No notes with this phrase</p>
